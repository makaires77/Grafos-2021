...
""" O algoritmo de Tarjan para o problema das componentes fortemente conectadas é uma extensão do algoritmo de Tarjan para o problema da conexão forte, é uma extensão da busca em profundidade.
    Ou seja, o algoritmo usa busca em profundidade e numera os vértices de acordo com o início e o fim da busca. 
    Procedimentos:
    1. Busca em profundidade iniciando de um vértice arbitrário.
    2. Para cada vértice realizar a busca em profundidade de seus nós adjacentes.
    3. Em cada busca realizada guardar em uma pilha o valor do vértice e guardar o nó-raiz de onde partiu.
    4. Para cada nó adjacente verificar o nível de conectividade é maior, ou seja o que tem menor lowlink entre  lowlink[v] ctx.index[w], se for atualizar o rótulo do nó na pilha e marcar como não-raiz.
    5. Se for um nó raiz, esvaziar a pilha por todos pertencerem a uma componente fortemente conectada, e atualizar o valor lowlink[x] para Infinito.
"""
